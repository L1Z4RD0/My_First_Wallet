...
.day-badge {
  ...
  font-weight: 800; padding: 0.35rem 0.8rem;
...
.nav-btn {
  ...
  font-weight: 700; color: var(--text-dark); cursor: pointer; transition: all 0.3s ease;
}
...
.streak-widget, .badge-widget, .energy-widget {
  display: flex; align-items: center; gap: 0.35rem;
  padding: 0.6rem 1rem; border-radius: 999px;
  font-weight: 800; font-size: 1rem;
  background: #f7f9fc; color: #2d3436; border: 1px solid #e3e8ef;
}
...
.wallet-widget {
  ...
  box-shadow: 0 4px 10px rgba(255,230,109,0.4); transition: var(--transition);
}
